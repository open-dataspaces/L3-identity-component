 ...
 *
 * This class contains unit tests for the NotFoundException class.
 *
 * Date: 2025/06/30
 */
...
/**
 * Unit tests for the {@link NotFoundException} class.
 */
public class NotFoundExceptionTest {
    ...
    @Test
    @DisplayName("Test NotFoundException constructor with message")
    void testParameterizedConstructor() {
        // Arrange
        // Act
        NotFoundException exception = new NotFoundException(commonMessage);
    ...
    @Test
    @DisplayName("Test NotFoundException constructor with message and cause")
    void testParameterizedConstructor_withCause() {
        // Arrange
        // Act
        NotFoundException exception = new NotFoundException(commonMessage, commonException);
